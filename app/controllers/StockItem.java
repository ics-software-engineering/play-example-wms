...
/**
 * The controller for the StockItem model.
 */
public class StockItem extends Controller {
  private static final int DEFAULT_NUM_ITEMS = 25;
  ...
  public static Result create() {
    models.StockItem defaults = new models.StockItem("ST-01", DEFAULT_NUM_ITEMS);
